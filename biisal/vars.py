...
class Var(object):
    ...
    BOT_TOKEN = str(getenv('BOT_TOKEN' , '7481340732:AAGkZysNbgl4hnmfFVrvks0W9u7D8JVcEt8'))
    name = str(getenv('name', 'THH_Streem_Bot'))
    SLEEP_THRESHOLD = int(getenv('SLEEP_THRESHOLD', '0'))
    WORKERS = int(getenv('WORKERS', '4'))
    BIN_CHANNEL = int(getenv('BIN_CHANNEL', '-1002111303673'))
    NEW_USER_LOG = int(getenv('NEW_USER_LOG', '-1002111303673'))
